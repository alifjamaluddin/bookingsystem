...
<div class="poster">
	...
	<!-- NEWS 1 -->
	<div aria-hidden="true" class="modal fade" id="modal" role="dialog" tabindex="-1" style="display: none;">
	...
	<!-- NEWS 2 -->
	<div aria-hidden="true" class="modal fade" id="modal2" role="dialog" tabindex="-1" style="display: none;">
		<div class="modal-dialog modal-xs">
			<div class="modal-content">
				<div class="modal-heading">
					<a class="modal-close" data-dismiss="modal">×</a>
...
<img src="images/news2.png" style="max-width:400px">
	...
	<!-- NEWS 2 -->
	<div aria-hidden="true" class="modal fade" id="modal3" role="dialog" tabindex="-1" style="display: none;">
		<div class="modal-dialog modal-xs">
			<div class="modal-content">
				<div class="modal-heading">
					<a class="modal-close" data-dismiss="modal">×</a>
	...
	<!-- NEWS 2 -->
	<div aria-hidden="true" class="modal fade" id="modal4" role="dialog" tabindex="-1" style="display: none;">
		<div class="modal-dialog modal-xs">
			<div class="modal-content">
				<div class="modal-heading">
					<a class="modal-close" data-dismiss="modal">×</a>
